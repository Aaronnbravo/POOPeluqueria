...
public class DashboardPanel extends JPanel {
   ...
   private void createQuickActionsPanel() {
    ...
    // ELIMINÉ el botón "Ver Reportes"

    quickActionsPanel.add(btnNuevoCliente);
    quickActionsPanel.add(btnNuevoServicio);
    quickActionsPanel.add(btnNuevoTurno);
    // quickActionsPanel.add(btnReportes); // ← ESTA LÍNEA SE ELIMINA

    // Event listeners
    btnNuevoCliente.addActionListener(e -> {
        // Aquí puedes agregar la funcionalidad para abrir el diálogo de nuevo cliente
    ...
    btnNuevoServicio.addActionListener(e -> {
        // Aquí puedes agregar la funcionalidad para abrir el diálogo de nuevo servicio
        JOptionPane.showMessageDialog(this, 
    ...
    btnNuevoTurno.addActionListener(e -> {
        // Aquí puedes agregar la funcionalidad para abrir el diálogo de nuevo turno
        JOptionPane.showMessageDialog(this, 
